...
namespace project_owners_net.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(davidgranadodatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var davidgranadodatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'davidgranadodatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
